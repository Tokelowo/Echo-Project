...
class CybersecurityNewsService:
    ...
    def fetch_cybersecurity_news(self, max_articles=10):
        ...
        # Try all sources for better content variety
        for source_id, source_config in self.sources.items():
            try:
                ...
                # If we have enough articles, we can stop early
    ...
    def _calculate_relevance(self, title, summary):
        ...
        # Base score for any cybersecurity content
        score += 1
        ...
        for keyword in self.mdo_keywords:
            if keyword in text:
                ...
                elif keyword in ['email security', 'phishing', 'malware', 'cybersecurity']:
